...
def get_rank(score):
    ...
    ranks = [
        ...
        (10, "🔫 Младший сержант"),
        (25, "⚔️ Сержант"),
        (50, "🎖️ Старший сержант"),
        (100, "🏅 Старшина"),
        
        # 📜 ПРАПОРЩИКИ (100-500)
        (250, "📜 Прапорщик"),
        (500, "⭐ Старший прапорщик"),
        
        # ⚔️ МЛАДШИЕ ОФИЦЕРЫ (500-2500)
        (750, "🎖️ Младший лейтенант"),
        (1000, "⭐ Лейтенант"),
        (1500, "⚡ Старший лейтенант"),
        (2500, "🏛️ Капитан"),
        
        # 👤 СТАРШИЕ ОФИЦЕРЫ (2500-25k)
        (5000, "🎖️ Майор"),
        (7500, "⭐ Подполковник"),
        (10000, "⚔️ Полковник"),
        ...
        # 🎖️ ГЕНЕРАЛЫ (25k-100k)
        (25000, "🌟 Генерал-майор"),
        (50000, "⭐⭐ Генерал-лейтенант"),
        (75000, "⭐⭐⭐ Генерал-полковник"),
        (100000, "👑 Генерал армии")
    ]
    ...
    # 🏅 МЕДАЛЬКИ ПОСЛЕ 100k (каждые 50k)
    medals = ""
    if score >= 100000:
        medal_count = (score - 100000) // 50000 + 1
        medals = " " + "🏅" * min(medal_count, 5)  # Макс 5 медалек
    
    return f"{base_rank}{medals}"
